        ...
        <div id="categories table" class="table-responsive">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><a href="/category/news/delete/<?php echo e($category->id); ?>">Dzēst</span></a></td>
                    <td><a data-js-type="open-remove"><span id="<?php echo e($category->id); ?>" class="btn btn-warning">Rediģēt</span></a></td>
                </tr>
